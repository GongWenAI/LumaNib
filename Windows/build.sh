...
"$DOTNET_BIN" publish "$PROJECT_DIR/src/LumaNib.csproj" -c Release -r win-x64 --self-contained true -p:PublishReadyToRun=false -o "$PROJECT_DIR/dist/LumaNib-1.59-win-x64"
