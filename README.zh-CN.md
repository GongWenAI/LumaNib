...
**免费使用，作者：宫文。** 本仓库已公开 Mac 和 Windows 源码，允许免费使用、修改和免费分享；未经作者书面许可，禁止销售原版或修改版。完整条款见 [LICENSE](LICENSE)，编译方法见 [构建说明](docs/BUILDING.md#简体中文)。
...
**© 2026 宫文。保留所有权利。** 源码依 [禁止销售许可](LICENSE) 提供，允许工作、教学和商业演示中的使用；这不是 MIT 或标准开源许可。第三方运行库依各自许可证提供。
